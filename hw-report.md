...
| Критерий	     	| Скомпилированный Си| С оптим. по скорости| С оптим. по размеру | Отредактированный вручную после компиляции |       
| ----------------------|:------------------:| :------------------:|:-------------------:|:------------------------------------------:|
| размер асм-файла	| 15 631 байт        | ...                 | ...                 |                                            |
| размер испол. файла	| 17 280 байт        | ...                 | ...                 |                                            |
| время работы		| ...                | ...                 | ...                 |                                            |
// размер асм-файла == размер 10 файлов расширения .s (из папки generated-asm-code для Си, ...) 
<br>
